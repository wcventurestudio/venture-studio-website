        ...
        <main className="min-h-screen bg-bg">
            ...
            <section className="pt-36 pb-16 px-6 md:px-10 max-w-2xl mx-auto">
                ...
                <div className="space-y-12 animate-fade-up animate-fade-up-delay-1">
                    <div>
                        <h2 className="font-display text-2xl font-black mb-5 text-fg">Williams Venture Studio</h2>
                        <p className="text-fg/60 leading-relaxed text-md mb-4">
                            We are a student organization at Williams College exploring startups, venture, and providing
